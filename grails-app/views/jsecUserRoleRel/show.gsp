...
<html>
    <head>
        ...
        <title>Show JsecUserRoleRel</title>
    </head>
    <body>
        <div class="nav">
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="jsecRole" action="show" id="${jsecUserRoleRelInstance?.role?.id}">${jsecUserRoleRelInstance?.role?.encodeAsHTML()}</g:link></td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="jsecUser" action="show" id="${jsecUserRoleRelInstance?.user?.id}">${jsecUserRoleRelInstance?.user?.encodeAsHTML()}</g:link></td>
