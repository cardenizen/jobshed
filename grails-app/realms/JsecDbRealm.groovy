...
import us.mn.state.dot.secure.JsecRolePermissionRel
import us.mn.state.dot.secure.JsecUserPermissionRel
import org.apache.log4j.Logger

class JsecDbRealm {
    static Logger log = Logger.getLogger(JsecDbRealm.class)
    ...
    def authenticate(authToken) {
        ...
        // If password is not blank and does not match the DB hash, throw and exception 
        if (!authToken.password == "" && !credentialMatcher.doCredentialsMatch(authToken, account)) {
