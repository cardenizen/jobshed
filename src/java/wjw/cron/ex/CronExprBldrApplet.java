...
public class CronExprBldrApplet extends JApplet {
    ...
    public String get()
    {
        return jTF_Cron_Exp.getText().trim();
    }

    public void put(String cronExpr) {
        jTF_Cron_Exp.setText(cronExpr.trim());
    }
    ...
    private void initComponents() {
      ...
      jTabbedPane1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Quartz Expression"));
      ...
      jPanel3Layout.setHorizontalGroup(
        ...
        .addGroup(jPanel3Layout.createSequentialGroup()
          ...
          .addComponent(jButton_Copy, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)
          .addGap(261, 261, 261)
          )
      );
...
//      setBounds((screenSize.width-778)/2, (screenSize.height-696)/2, 778, 696);
      ...
      private void jButton_ParseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ParseActionPerformed
        try {
          ...
          //ex.printStackTrace();
          JOptionPane.showMessageDialog(this, "MessageDialog Cron:" + ex);
        }
        ...
        try {
          ...
          if (jCB_WK_Use.isSelected()) {
            ...
            if (jRB_WK_Every.isSelected()) {
              ...
              if (jTF_Cron_Week.getText().length() == 0) {
                throw new VerifyError("Verify Error - Cron_Week!");
              }
            ...
            if (jRB_DD_Every.isSelected()) {
              ...
              if (jTF_Cron_Day.getText().length() == 0) {
                throw new VerifyError("Verify Error - Cron_Day!");
              }
            }
          }
          ...
          if (jRB_MM_Every.isSelected()) {
            ...
            if (jTF_Cron_Month.getText().length() == 0) {
              throw new VerifyError("VerifyError - Cron Month!");
            }
          }
